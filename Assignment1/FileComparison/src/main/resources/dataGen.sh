...
case "$1" in
    ...
    *)
        ...
        echo "  '-genAll [Number of valid file sets] [Number of characters] -- To generate full data sets"
        ...
        echo "  '-gen66' -- To generate two files with 66.7% similarity"
        echo "  '-gen50' -- To generate two files with 50% similarity"
        ...
        echo "  '-clean' -- To delete any valid files types within script directory"
        echo ""
        echo "-----------------------------------------------------------------------------------------------------"
        echo "WARNING: Run the script and generate files in a specific directory separate to other project files!!!"
        echo "-----------------------------------------------------------------------------------------------------"
        echo ""
